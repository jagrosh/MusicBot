...
public class FairQueue<T extends Queueable> {
    ...
    public int removeAll(long identifier) {
        ...
        this.removeControlsFromLastMessage();
        return count;
    }
    ...
    public void setLastMessage(Message msg) {
        if (msg != null)
            this.removeControlsFromLastMessage();
        this.this_last_message = msg;
    }

    public Message getLastMessage() {
        return this.this_last_message;
    }

    public void removeControlsFromLastMessage() {
        if (this.this_last_message != null)
            this.this_last_message.editMessage(this.this_last_message.getEmbeds().get(0)).override(true).queue();
    }
}
