    ...
    public SettingsManager() {
        ...
        try {
            ...
            loadedSettings.keySet().forEach(id -> {
                ...
                settings.put(Long.parseLong(id), new Settings(
                    this,
            ...
            try {
                LoggerFactory.getLogger("Settings")
                    .info("serversettings.json will be created in {}",
        ...
        LoggerFactory.getLogger("Settings")
            .info("serversettings.json loaded from {}", OtherUtil.getPath("serversettings.json").toAbsolutePath());
    }
