...
public class Settings implements GuildSettingsProvider {
    ...
    public Settings(
        SettingsManager manager, String textId, String voiceId, String roleId, int volume, String defaultPlaylist,
    ...
    public Settings(
        SettingsManager manager, long textId, long voiceId, long roleId, int volume, String defaultPlaylist,
        RepeatMode repeatMode, String prefix, double skipRatio, QueueType queueType) {
        this.manager = manager;
        this.textId = textId;
