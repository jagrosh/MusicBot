...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler {
    ...
    public Message getNowPlaying(JDA jda) {
        if(isMusicPlaying(jda)) {
            ...
            mb.append(FormatUtil.filter(
                manager.getBot().getConfig().getSuccess() + " **Now Playing in " + guild.getSelfMember().getVoiceState()
            ...
            if(rm.getOwner() != 0L) {
                ...
                if(u == null) {
                    ...
                    FormatUtil.formatUsername(u), null, u.getEffectiveAvatarUrl());
                }
            }
    ...
    public Message getNoMusicPlaying(JDA jda) {
        ...
        return new MessageBuilder()
            ...
            .setEmbeds(new EmbedBuilder()
                ...
                .setDescription(STOP_EMOJI + " " + FormatUtil.progressBar(-1) + " " + FormatUtil.volumeIcon(
